        ...
        <content>
            ...
            ?>
                <div class="div title_div">
                    <p style='font-size:20px;'>Акт выдачи невостребованного питания КультПульт</p>
                </div>
                <br>
                <hr>
                <!-- Word форма -->
                ...
                <div class = 'statements_div'>
                    ...
                    ?>
                    <?php
                    echo "<a id = 'btn_word' class = 'btn_download'><input class='btn btn_ok' type='submit' value='Получить Word'></a>"
                    ?>
                </div>
